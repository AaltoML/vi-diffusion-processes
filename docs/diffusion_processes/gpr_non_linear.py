...
@hydra.main(version_base="1.2", config_path="configs/", config_name="gpr_non_linear_process")
def run_experiment(cfg: DictConfig):
    ...
    kernel = OrnsteinUhlenbeck(decay=(Q.item()/2), diffusion=Q)
